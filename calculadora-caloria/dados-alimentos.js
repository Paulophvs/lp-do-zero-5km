...
const ALIMENTOS = [
  ...
  // ~313-350kcal/26,9g por 100g, misturados 60% batata / 40% carne por peso.
  // AUDITORIA 19/08: era "porcao individual/grande" em tamanho fixo, mas "grande pra
  // dividir" dava a caloria do prato INTEIRO pra 1 pessoa quando é feito pra compartilhar
  // entre varias pessoas na mesa (superestimava). Trocado pra 1 punhado incrementavel por
  // clique (mesmo padrao do resto do site), valor = ~1/3 da porcao individual de 150g.
